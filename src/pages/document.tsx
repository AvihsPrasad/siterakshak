        ...
        <div className="doc-page">
            <div className="bannerblock d-flex justify-content-center align-items-center">
                <div className="container">
                    <h1>We do any documentation on your behalf.</h1>
                    <p>We create any documemntion or update your properties documentatin on behalf of you, also help you in tranfer of properties.</p>
                    {/* <div><button type="button" className="btn btn-dark btn-lg">Know More</button></div> */}
                </div>
            </div>
            <div className="doc-info pad-80">
                <div className="container">
                    ...
                    <div className="row m-0">
                        <div className="col-sm-12 col-md-6 col-lg-6">
                            <div className="accordion accordion-flush" id="accordionFlushExample1">
                                ...
                                <div className="accordion-item">
                                    <h2 className="accordion-header" id="flush-headingTwoo">
                                        <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseTwoo" aria-expanded="false" aria-controls="flush-collapseTwo">
                                            Property Sketch
                                        </button>
                                    </h2>
                                ...
                                <div className="accordion-item">
                                    <h2 className="accordion-header" id="flush-headingThreee">
                                        <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseThreee" aria-expanded="false" aria-controls="flush-collapseThree">
                                            Others
                                        </button>
                                    </h2>
                                    <div id="flush-collapseThreee" className="accordion-collapse collapse" aria-labelledby="flush-headingThreee" data-bs-parent="#accordionFlushExample1">
                                        <div className="accordion-body">
                                            <p>Property Bills are paid and recipts are sent to you.</p>
                                            <ul>
                                                <li><p>Property tax</p></li>
                                                <li><p>water tax</p></li>
                                                <li><p>Sale deed</p></li>
                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <div className="">
                                <h2><span>Enter your Phone number</span></h2>
                                <p>Our team will get back to within 24 hrs</p>
                                <div className="mb-4">
                                    {/* <label htmlFor="exampleFormControlInput1" className="form-label">Email address</label> */}
                                    <input type="text" className="form-control" id="exampleFormControlInput1" placeholder="(+91)***-***-****" />
                                </div>
                                <button type="button" className="btn btn-dark">Request a callback</button>
                            </div>
                        </div>
